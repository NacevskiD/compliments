...
public class ComplimentClient {
    ...
    private static final String SERVER_URL = "https://glacial-citadel-91425.herokuapp.com/";
    ...
    public static void getCompliment(final ComplimentsGUI gui) {

            Unirest.get(SERVER_URL + "random").header("accept", "application/json").asJsonAsync
